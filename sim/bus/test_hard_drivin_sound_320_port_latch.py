...
class HardDrivinSound320PortLatchTests(unittest.TestCase):
    def test_all_words_ports_commits_and_validity(self) -> None:
        verilator = shutil.which("verilator")
        if verilator is None:
            raise RuntimeError("Verilator is required once architectural RTL exists")
        name = "tb_hard_drivin_sound_320_port_latch"
