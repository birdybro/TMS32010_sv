...
module tb_sequential_pipeline_differential;
  ...
  initial begin
    ...
    program_memory[46] = 16'h7f83;  // unsupported boundary
    ...
    for (int unsigned retirement = 1; retirement <= 46; retirement++) begin
      advance_to_shared_sample();
