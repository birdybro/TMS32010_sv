...
module tb_sequential_pipeline_slice;
  ...
  initial begin
    ...
    program_memory[4] = 16'hf500;  // BV: valid, but outside this slice
    ...
    require(
      ...
      "NOP retires while unsupported BV enters execute ownership"
    );
    require(
    ...
    repeat (8) begin
      ...
      require(
        ...
        "blocked slice cannot access or retire the BV operand"
      );
      require(accumulator == 32'h0000_00a5,
              "parked BV operand cannot affect the accumulator");
    end
