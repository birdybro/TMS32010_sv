...
module tb_sequential_pipeline_slice;
  ...
  initial begin
    ...
    program_memory[4] = 16'hf900;  // B: valid, but outside this slice
    ...
    require(
      ...
      "NOP retires while the multicycle branch enters execute ownership"
    );
    require(
      pipeline_blocked && !illegal,
      "multicycle word parks visibly before legacy timing is invented"
    );
    ...
    repeat (8) begin
      ...
      require(
        ...
        "blocked slice cannot access or retire the branch operand"
      );
      require(accumulator == 32'h0000_00a5,
              "parked branch operand cannot affect the accumulator");
    end
