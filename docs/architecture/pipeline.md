...
of arbitrary programs or memory systems, or the general pipeline.

A third depth-80 harness composes four nested CALLs, distinct full-stack
state, `LARK AR0,5; LARK AR1,9; LACK 0x20`, indirect `TBLR *+,AR1`, and a
