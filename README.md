...
The reference model, local tools, and partial RTL currently support twenty-six
instructions: `ADD`, `ADDS`, `AND`, `LAC`, `LACK`, `LAR`, `LARK`, `LARP`, `LDP`,
`LDPK`, `LT`, `MAR`, `MPY`, `NOP`, `OR`, `ROVM`, `SACL`, `SACH`, `SAR`,
...
twenty-six-instruction subset only; it is not a general pipeline or
