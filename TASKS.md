...
- **Notes:** Fifty-six encodings (`ADD`, `ADDS`, `AND`, `APAC`, `B`, `BANZ`, `BGEZ`, `BGZ`, `BIOZ`, `BLEZ`, `BLZ`, `BNZ`, `BV`, `BZ`, `CALA`, `CALL`, `DINT`, `DMOV`, `EINT`, `IN`, `LAC`, `LACK`, `LAR`,
  ...
  against this partial set, accepting 21,586 supported words without
  collisions; the remaining 4
  ...
  are primary-verified; its second external cycle remains `OQ-007`. SUBC's
  encoding,
...
- **Notes:** Qualified slice supports the same fifty-six instructions as the
  ...
  directed-tested. The remaining 4
