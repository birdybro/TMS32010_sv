...
- **Notes:** Fifty-five encodings (`ADD`, `ADDS`, `AND`, `APAC`, `B`, `BANZ`, `BGEZ`, `BGZ`, `BIOZ`, `BLEZ`, `BLZ`, `BNZ`, `BV`, `BZ`, `CALL`, `DINT`, `DMOV`, `EINT`, `IN`, `LAC`, `LACK`, `LAR`,
  ...
  against this partial set, accepting 21,585 supported words without
  collisions; the remaining 5
  ...
  not be generated by the assembler. SUBC's encoding,
...
- **Notes:** Independent model supports `ADD`, `ADDS`, `AND`, `APAC`, `B`, `BANZ`, `BGEZ`, `BGZ`, `BIOZ`, `BLEZ`, `BLZ`, `BNZ`, `BV`, `BZ`, `CALL`, `DINT`, `DMOV`, `EINT`, `IN`, `LAC`, `LACK`,
  ...
  families, complete overlapped pipeline timing, RTL/native RET/PUSH/POP
  timing, and untested interrupt arrival combinations remain unimplemented.
...
- **Notes:** Qualified slice supports the same fifty-five instructions as the
  ...
  PAC/APAC/SPAC/DINT/EINT/POP/PUSH/RET and two-word
  ...
  directed-tested. The remaining 5
...
- **Notes:** Normal memory read, TBLR/TBLW, IN/OUT, reset, INT, and BIO pin
  ...
  Other control flow remains. PUSH/POP are model-asserted as
