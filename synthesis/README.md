...
The checked-in projects synthesize the current fifty-instruction
...
for the current 37 one-cycle instructions, eleven qualified two-cycle
control-flow paths, and two native IN/OUT paths.
Yosys 0.67+111 from
