...
These results cover the forty-six-instruction RTL, signed multiplier,
...
- DSP blocks: 1.
- PLLs: 0.
- Worst internal setup slack across analyzed corners: +3.144 ns at 50 MHz.
- Worst internal hold slack across analyzed corners: +0.165 ns.
- Slow-corner internal Fmax: 59.69 MHz at 100 °C, 59.33 MHz at -40 °C.
...
remain represented, and the generic result contains 12,590 cells. The
