...
These results cover the twenty-three-instruction RTL, 144-word internal data RAM, and
...
- DSP blocks: 0.
- PLLs: 0.
- Worst internal setup slack across analyzed corners: +2.693 ns at 50 MHz.
- Worst internal hold slack across analyzed corners: +0.167 ns.
- Slow-corner internal Fmax: 57.78 MHz at 100 °C, 58.11 MHz at -40 °C.
...
remain represented, and the generic result contains 8,227 cells. The
