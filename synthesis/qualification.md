...
These results cover the twenty-two-instruction RTL, 144-word internal data RAM, and
...
- DSP blocks: 0.
- PLLs: 0.
- Worst internal setup slack across analyzed corners: +4.135 ns at 50 MHz.
- Worst internal hold slack across analyzed corners: +0.135 ns.
- Slow-corner internal Fmax: 63.03 MHz at 100 °C, 64.05 MHz at -40 °C.
...
remain represented, and the generic result contains 8,200 cells. The
