...
recognizes the thirty-two-instruction model/tool slice. Unknown words are
...
noncanonical indirect `ADD`, `ADDS`, `AND`, `LAC`, `LAR`, `LDP`, `LT`, `LTA`, `LTD`, `MPY`, `OR`, `SACL`,
`SACH`, `SAR`, `SUB`, `SUBS`, `XOR`, `ZALH`, or `ZALS` whose
