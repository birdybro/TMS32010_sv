...
recognizes the twenty-three-instruction model/tool slice. Unknown words are rendered
...
noncanonical indirect `ADD`, `ADDS`, `AND`, `LAC`, `LAR`, `OR`, `SACL`, `SACH`, `SAR`, `SUB`, `SUBS`, `XOR`,
`ZALH`, or `ZALS` whose
